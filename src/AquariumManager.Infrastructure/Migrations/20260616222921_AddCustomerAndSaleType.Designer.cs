...
namespace AquariumManager.Infrastructure.Migrations
{
    ...
    [Migration("20260616222921_AddCustomerAndSaleType")]
    partial class AddCustomerAndSaleType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AquariumManager.Domain.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AquariumManager.Domain.Entities.Sale", b =>
                {
                    b.HasOne("AquariumManager.Domain.Entities.Customer", "Customer")
                        .WithMany("Sales")
